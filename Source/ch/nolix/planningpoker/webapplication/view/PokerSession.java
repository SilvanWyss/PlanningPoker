...
import ch.nolix.planningpoker.webapplication.roomcomponent.RoomComponent;
...
public final class PokerSession extends PageSession {
  ...
  protected IControl<?, ?> createMainControl(final IDataAdapter dataAdapter) {
    return new RoomComponent(userId, dataAdapter, this, SelectRoomSession::withUserId).getStoredControl();
  }
